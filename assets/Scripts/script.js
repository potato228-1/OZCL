...
advantagesList.addEventListener("mouseover", (event) => {
	if (event.target.closest(".advantages_item")) {
		if (
			event.target.closest(".advantages_item").classList.contains("item1")
		) {
			b = 1;
			document
...
setInterval(() => {
	if (i > 3) {
		...
		if (i == 1) {
			document
				.querySelector(".currentDescription")
				.classList.remove("currentDescription");
			document
				.querySelector(".description1")
				.classList.add("currentDescription");
			document
				.querySelector(".currentOption")
				.classList.remove("currentOption");
